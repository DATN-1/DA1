...
export default function ProductDetail() {
    ...
    const handleQuantityChange = (newQty: number) => {
        if (product) {
            const maxQty = 45; // You can change this based on actual stock
    ...
    const productPrice = (product.price || 0) * 25000;
    ...
    <section style={{padding: "3rem 0", background: "linear-gradient(135deg, #fef3c7, #ffe4e6)"}}>action
        <div className="container">
            <div className="product-detail-container">
                {/* <!-- Image Gallery --> */}
                <div className="product-gallery">
                    <div className="main-image-container">
                        <img id="main-image" src={productImage} alt={product.name} className="main-product-image" />
                        <div className="product-badge-detail" id="product-badge">New</div>
                    </div>
                    <div className="thumbnail-container">
                        <img src={productImage} alt="Thumbnail 1" className="thumbnail active" onClick={() => {}} />
                ...
                <div className="product-detail-info">
                    ...
                    <div className="price-section">
                        <span className="current-price" id="product-price">{new Intl.NumberFormat('vi-VN').format(productPrice)} VND</span>
                        <span className="original-price">{new Intl.NumberFormat('vi-VN').format(productPrice * 1.28)} VND</span>
                    ...
                    <div className="product-actions-detail">
                        <button className="btn btn-gradient btn-large" onClick={handleAddToCart}>
