...
export default function Product(){
    ...
    return (
        <main>
            <section className="gradient-bg" style={{minHeight: "100vh", padding: "4rem 0"}}>
        <div className="container">
            ...
            <div className="section-header">
                ...
                <p style={{fontSize: "1.125rem", color: "#6b7280", maxWidth: "42rem", margin: "0 auto"}}>
                    Khám phá những mùi hương độc đáo, mang đến không gian thư giãn và ấm cúng cho ngôi nhà của bạn
                </p>
            </div>
            ...
            <div className="search-container">
                ...
                <input type="text" className="search-input" id="productSearch" placeholder="Tìm kiếm sản phẩm theo tên..." />
            </div>
            ...
            <div className="products-layout">
                ...
                <div className="product-card">
                    ...
                    <div className="product-info">
                        ...
                        <div className="product-actions">
                            <Link href="/product-detail/2" className="btn btn-dark">Xem Chi Tiết</Link>
                            <button 
                            className="btn btn-amber" 
                            onClick={() => 
                                cartAddToCart({
                ...
                <div className="product-card">
                    ...
                    <div className="product-info">
                        ...
                        <div className="product-actions">
                            <Link href="/product-detail/3" className="btn btn-dark">Xem Chi Tiết</Link>
                            <button 
                            className="btn btn-amber" 
                            onClick={() => 
                                cartAddToCart({
                ...
                <div className="product-card">
                    ...
                    <div className="product-info">
                        ...
                        <div className="product-actions">
                            <Link href="/product-detail/4" className="btn btn-dark">Xem Chi Tiết</Link>
                            <button 
                            className="btn btn-amber" 
                            onClick={() => 
                                cartAddToCart({
                ...
                <div className="product-card">
                    <div className="product-image-container">
                        <img src="../images/cinnamon.jpg" alt="Cinnamon Spice" className="product-image" />
                        <div className="product-badge">New</div>
                    </div>
                    <div className="product-info">
                        ...
                        <div className="product-actions">
                            <Link href="/product-detail/5" className="btn btn-dark">Xem Chi Tiết</Link>
                            <button 
                            className="btn btn-amber" 
                            onClick={() => 
                                cartAddToCart({
                ...
                <div className="product-card">
                    ...
                    <div className="product-info">
                        ...
                        <div className="product-actions">
                            <Link href="/product-detail/6" className="btn btn-dark">Xem Chi Tiết</Link>
                            <button 
                            className="btn btn-amber" 
                            onClick={() => 
                                cartAddToCart({
