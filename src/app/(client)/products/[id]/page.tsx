...
export default function ProductDetail() {
    ...
    if(!product) {
        return (
            <div className="container">
                <div className="error">Sản phẩm không tồn tại</div>
            </div>
        );
    }
...
const mainImage = imageList[0] || "../images/default-product.png";
            ...
            <div className="product-detail-container">
                ...
                <div className="product-gallery">
                    <div className="main-image-container">
                        <img id="main-image" src={mainImage} alt="Product" className="main-product-image" />
                        <div className="product-badge-detail" id="product-badge">New</div>
                    </div>
                    <div className="thumbnail-container">
                        <img src={imageList[0] || "../images/lavender.jpg"} alt="Thumbnail 1" className="thumbnail active" onClick={() => {}} />
                        <img src={imageList[1] || "../images/vanilla.jpg"} alt="Thumbnail 2" className="thumbnail" onClick={() => {}} />
                        <img src={imageList[2] || "../images/rose.jpg"} alt="Thumbnail 3" className="thumbnail" onClick={() => {}} />
                        <img src={imageList[3] || "../images/ocean.jpg"} alt="Thumbnail 4" className="thumbnail" onClick={() => {}} />
                    </div>
                </div>

                {/* <!-- Product Info --> */}
                <div className="product-detail-info">
                    <h1 id="product-title" className="product-detail-title">{product?.name || "Lavender Bliss"}</h1>
                    ...
                    <p id="product-description" className="product-detail-description">
                        {product?.description || "Nến thơm Lavender Bliss mang đến hương thơm oải hương nhẹ nhàng, giúp thư giãn tinh thần và cải thiện giấc ngủ. Được làm từ 100% sáp đậu nành tự nhiên và tinh dầu oải hương nguyên chất."}
                    </p>
